...
namespace LightBoard.DataAccess.Migrations.Migrations
{
    ...
    [Migration("20220701195128_AddBoardIdColumnToActionHistoryRecordsTable")]
    partial class AddBoardIdColumnToActionHistoryRecordsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightBoard.Domain.Entities.Record.ActionHistoryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_action_history_records");

                    b.HasIndex("BoardId")
                        .HasDatabaseName("ix_action_history_records_board_id");

                    b.ToTable("action_history_records", (string)null);
                });
            ...
            modelBuilder.Entity("LightBoard.Domain.Entities.Record.ActionHistoryRecord", b =>
                {
                    b.HasOne("LightBoard.Domain.Entities.Boards.Board", null)
                        .WithMany()
                        .HasForeignKey("BoardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_action_history_records_boards_board_temp_id2");
                });
